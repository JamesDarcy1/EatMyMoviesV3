...
namespace EatMyMovies.DataAccess.Repositories
{
	public interface IRankingRepository
	{
        ...
        Task<List<AdminListMovieRow>> GetListMovieRowsAsync(Guid listId, CancellationToken cancellationToken = default);
        Task<ListRanking?> GetListRankingAsync(Guid movieId, Guid listId, CancellationToken cancellationToken = default);
        Task<List<AdminMovieMembership>> GetMovieMembershipsAsync(Guid movieId, CancellationToken cancellationToken = default);
        ...
        Task RemoveListRankingAndCloseGapAsync(Guid movieId, Guid listId, CancellationToken cancellationToken = default);
